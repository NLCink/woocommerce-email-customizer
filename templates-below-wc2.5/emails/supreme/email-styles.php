...
// Header Styling
$header_bg_color				= get_option( "ec_supreme_all_header_color" );  //"#fdfdfd";
...
$body_text_color		= get_option( "ec_supreme_all_text_color" ); // "#3d3d3d";
...
/* FOOTER */
.footer_container { font-family: Arial,sans-serif; font-size: 12px; text-align: center; padding: 12px 55px 16px; border-top: 1px solid <?php echo $footer_border_bottom_color ?>; color: <?php echo $footer_text_color ?>; background-color: <?php echo $footer_bg_color ?>; }
