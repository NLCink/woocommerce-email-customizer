<?php
/**
 * Plugin Name: WooCommerce Email Customizer Control
 * Description: WooCommerce Email Customizer Control plugin allows you to fully customize the styling, colors, logo and text in the emails sent from your WooCommerce store.
 * Author: jakir
 * Author URI:
 * Plugin URI:
 * Version: 3.03
...
class WC_Email_Control {
  ...
  die();
	...
	*/
	...
	function orderCompletionFormClb( $page_template )
	{
